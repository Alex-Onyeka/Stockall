...
void downloadPdfWebPurchase({
  required TempPurchase purchase,
  required List<TempItemPurchaseRecord> records,
  ...
  SalesAuthAction().downloadReceiptAction(
    ...
    action: () async {
      try {
        final pdfBytes = await _buildPdfPurchase(
          purchase: purchase,
          records: records,
          context: context,
...
Future<Uint8List> _buildPdfPurchase({
  required TempPurchase purchase,
  required List<TempItemPurchaseRecord> records,
            ...
            pw.DefaultTextStyle(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  //                             fontSize: 8,
                  //                           ),
                  //                           'Cash: ${formatMoneyMid(amount: purchase.cashAlt, context: context)}',
                  //                         ),
                  //                         pw.Text(
                  //                           style: pw.TextStyle(
                  //                             font:
                  ...
                  //                             fontSize: 8,
                  //                           ),
                  //                           'Bank: ${formatMoneyMid(amount: purchase.bank, context: context)}',
                  //                         ),
                  //                       ],
                  //                     ),
                  //                   ],
...
Future<void> generateAndPreviewPdfPurchase({
  required TempPurchase purchase,
  required List<TempItemPurchaseRecord> records,
  required BuildContext context,
}) async {
  SalesAuthAction().downloadReceiptAction(
    ...
    action: () async {
      ...
      final Uint8List bytes = await _buildPdfPurchase(
        purchase: purchase,
        shop: returnShopProvider().userShop()!,
        records: records,
        context: context,
      ...
      var name =
          "Stockall_Purchase_$purchaseId.${DateTime.now().millisecondsSinceEpoch}";
...
void downloadPdfWebRollPurchase({
  required TempPurchase purchase,
  required List<TempItemPurchaseRecord> records,
  required TempShopClass shop,
  required BuildContext context,
  ...
  SalesAuthAction().printReceiptAction(
    ...
    action: () async {
      try {
        ...
        final pdfBytes = await _buildPdfRollPurchase(
          purchase: purchase,
          records: records,
          shop: returnShopProvider().userShop()!,
          context: context,
...
Future<Uint8List> _buildPdfRollPurchase({
  required TempPurchase purchase,
  required List<TempItemPurchaseRecord> records,
  required TempShopClass shop,
  required BuildContext context,
...
Future<void> generateAndPreviewPdfRollPurchase({
  required TempPurchase purchase,
  required List<TempItemPurchaseRecord> records,
  required TempShopClass shop,
  required BuildContext context,
