                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        ...
                        message ??
                            'This feature is beyond your current plan [ ${currentSubscription(context: context)?.getPlanName()} Plan ]. You have to upgrade your plan to be able to access this Feature.',
                      ),
                    ),
                    SizedBox(height: 20),
                    ConstrainedBox(
