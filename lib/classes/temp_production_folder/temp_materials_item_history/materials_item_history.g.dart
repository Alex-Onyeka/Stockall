...
part of 'materials_item_history.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MaterialsItemHistoryAdapter extends TypeAdapter<MaterialsItemHistory> {
  @override
  final int typeId = 117;

  @override
  MaterialsItemHistory read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MaterialsItemHistory obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.uuid)
  ...
  bool operator ==(Object other) =>
      ...
      other is MaterialsItemHistoryAdapter &&
