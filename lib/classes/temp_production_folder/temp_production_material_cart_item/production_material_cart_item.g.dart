...
part of 'production_material_cart_item.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ProductionMaterialCartItemAdapter
    extends TypeAdapter<ProductionMaterialCartItem> {
  @override
  final int typeId = 120;

  @override
  ProductionMaterialCartItem read(BinaryReader reader) {
  ...
  bool operator ==(Object other) =>
      ...
      other is ProductionMaterialCartItemAdapter &&
