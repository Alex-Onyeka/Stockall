...
class MyDrawerWidgetDesktop extends StatefulWidget {
  ...
  @override
  State<MyDrawerWidgetDesktop> createState() =>
      _MyDrawerWidgetDesktopState();
}

class _MyDrawerWidgetDesktopState
    extends State<MyDrawerWidgetDesktop> {
  @override
