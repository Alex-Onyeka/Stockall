...
class SearchReceiptDesktop extends StatefulWidget {
  final TextEditingController searchController;
  const SearchReceiptDesktop({
    super.key,
    required this.searchController,
  });

  @override
  State<SearchReceiptDesktop> createState() =>
      _SearchReceiptDesktopState();
}

class _SearchReceiptDesktopState
    extends State<SearchReceiptDesktop> {
