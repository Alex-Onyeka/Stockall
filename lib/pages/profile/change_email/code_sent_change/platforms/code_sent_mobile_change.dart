...
class CodeSentMobileChange extends StatefulWidget {
  final ThemeProvider theme;
  final List circles;
  const CodeSentMobileChange({
    super.key,
  ...
  @override
  State<CodeSentMobileChange> createState() =>
      _CodeSentMobileChangeState();
}

class _CodeSentMobileChangeState
    extends State<CodeSentMobileChange> {
  int time = 120;
  Timer? _timer;
