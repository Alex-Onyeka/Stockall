...
class VerifyEmailDesktopChange extends StatefulWidget {
  ...
  const VerifyEmailDesktopChange({
    super.key,
    required this.theme,
  ...
  @override
  State<VerifyEmailDesktopChange> createState() =>
      _VerifyEmailDesktopChangeState();
}

class _VerifyEmailDesktopChangeState
    extends State<VerifyEmailDesktopChange> {
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          if (time < 20) {
                                            ...
                                            await AuthService()
                                                .resendEmailChangeVerificationOTP(
                                                  widget
                                                      .newEmail,
                                                );
                                            setState(() {
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                'Resend OTP To Verify Your New Email',
                                              ),
                                              Stack(
                                                alignment:
                                                    Alignment(
