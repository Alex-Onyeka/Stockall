...
class ShopSetupMobile extends StatefulWidget {
  ...
  const ShopSetupMobile({super.key, this.shop});

  @override
  State<ShopSetupMobile> createState() =>
      _ShopSetupMobileState();
}

class _ShopSetupMobileState extends State<ShopSetupMobile> {
