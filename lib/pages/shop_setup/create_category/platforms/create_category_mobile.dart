...
class CreateCategoryMobile extends StatefulWidget {
  const CreateCategoryMobile({super.key});

  @override
  State<CreateCategoryMobile> createState() =>
      _CreateCategoryMobileState();
}

class _CreateCategoryMobileState
    extends State<CreateCategoryMobile> {
