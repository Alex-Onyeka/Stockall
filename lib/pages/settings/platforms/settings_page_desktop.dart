...
import 'package:stockall/pages/settings/components/toggle_print_continuous_docket.dart';
                                    ...
                                    action: () async {
                                      bool isOnline =
                                          ConnectivityProvider()
                                              .isConnected;
                                      if (isOnline) {
                                        MultipleStoresAuthAction().manageShopDashboardAction(
                                            ...
                                            showDialog(
                                              ...
                                              builder: (
                                                ...
                                                return DialogTemplate(
                                                  ...
                                                  action: () async {
                                                    var password =
                                                        userP.currentUserMain!.password;
