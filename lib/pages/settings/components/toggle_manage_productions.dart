...
class ToggleManageProductions extends StatelessWidget {
  const ToggleManageProductions({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      visible:
          authorization(
            authorized:
                Authorizations().toggleManageProductions,
          ) &&
          !isStoreKeeper(),
      child: SubWrapper(
        isVisible:
                    ...
                    return ConfirmationAlert(
                      ...
                      message:
                          shopProvider
                                      ...
                                      .manageProductions ??
                                  true
                              ? 'You can no longer manage your productions, are you sure you want to proceed?'
                              : 'You can now manage your productions, are you sure you want to proceed?',
                      title:
                          shopProvider
                                      .userShop()!
                                      .manageProductions ??
                                  true
                              ? 'Turn Off Productions'
                              : 'Turn On Productions',
                      action: () async {
