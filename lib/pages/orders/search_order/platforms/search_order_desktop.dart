...
class SearchOrderDesktop extends StatefulWidget {
  final TextEditingController searchController;
  const SearchOrderDesktop({
    super.key,
    required this.searchController,
  });

  @override
  State<SearchOrderDesktop> createState() =>
      _SearchOrderDesktopState();
}

class _SearchOrderDesktopState
    extends State<SearchOrderDesktop> {
