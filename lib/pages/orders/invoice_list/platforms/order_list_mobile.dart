...
class OrderListMobile extends StatefulWidget {
  ...
  @override
  State<OrderListMobile> createState() =>
      OrderListMobileState();
}

class OrderListMobileState extends State<OrderListMobile> {
...
class OrderListBodyMobile extends StatefulWidget {
  final String? customerUuid;
  final String? agentUuid;
  final String? subStaffId;
  const OrderListBodyMobile({
    super.key,
    this.customerUuid,
    this.agentUuid,
    this.subStaffId,
  ...
  @override
  State<OrderListBodyMobile> createState() =>
      _OrderListBodyMobileState();
}

class _OrderListBodyMobileState
    extends State<OrderListBodyMobile> {
  Future<void> getOrders() async {
    await returnOrdersProvider().loadOrders(shopId());
    setState(() {});
  }
