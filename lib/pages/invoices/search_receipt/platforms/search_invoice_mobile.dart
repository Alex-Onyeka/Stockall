...
class SearchInvoiceMobile extends StatefulWidget {
  final TextEditingController searchController;
  const SearchInvoiceMobile({
    super.key,
    required this.searchController,
  });

  @override
  State<SearchInvoiceMobile> createState() =>
      _SearchInvoiceMobileState();
}

class _SearchInvoiceMobileState
    extends State<SearchInvoiceMobile> {
