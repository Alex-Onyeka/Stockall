...
class AddProductionItemDesktop extends StatefulWidget {
  ...
  @override
  State<AddProductionItemDesktop> createState() =>
      _AddProductionItemDesktopState();
}

class _AddProductionItemDesktopState
    extends State<AddProductionItemDesktop> {
      ...
      showDialog(
        ...
        builder: (context) {
          ...
          return InfoAlert(
            theme: theme,
            message:
                'Production Item Name Must be set before item can be created',
            title: 'Empty Input',
          );
        },
      );
      ...
      showDialog(
        ...
        builder: (confirmDialog) {
          return ConfirmationAlert(
            ...
            message:
                samePro.isNotEmpty
                    ? 'Production Item with the name  ${widget.nameController.text.toUpperCase()}  already Exists in your Inventory. Are you sure you want to proceed to create a duplicate Item?'
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      clearFields();
      FocusScope.of(context).requestFocus(nameFieldNode);
    });
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    ...
                                                    'Allow Stockall to Manage Production Item Quantity?',
                                                  ),
                                                  Column(
                                                    spacing:
                                                        5,
                                                    children: [
                                                      Text(
                                                        ...
                                                        'This controls whether Production Item quantity is automatically deducted after sales, and notifications are sent when item quantity is low or out of stock.',
                                                      ),
                                                    ],
                                                  ),
                                                ],
