...
class SupplierPageMobile extends StatelessWidget {
  final String uuid;
  const SupplierPageMobile({super.key, required this.uuid});

  @override
  Widget build(BuildContext context) {
    var theme = returnTheme(context);
    var tempSupplier = returnSuppliersProvider(
      context: context,
    ).suppliers.where((cust) => cust.uuid! == uuid);
    var supplier =
        tempSupplier.isNotEmpty
            ? tempSupplier.first
            : SuppliersClass(
              name: 'Name',
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return ConfirmationAlert(
                        theme: theme,
                        message:
                            'You are about to delete your supplier, are you sure you want to proceed?',
                        title: 'Are you sure?',
                        action: () async {
...
class SupplierDetailsContainer extends StatelessWidget {
