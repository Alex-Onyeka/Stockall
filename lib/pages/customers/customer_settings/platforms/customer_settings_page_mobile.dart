...
class CustomerSettingsPageMobile extends StatefulWidget {
  const CustomerSettingsPageMobile({super.key});

  @override
  State<CustomerSettingsPageMobile> createState() =>
      _CustomerSettingsPageMobileState();
}

class _CustomerSettingsPageMobileState
    extends State<CustomerSettingsPageMobile> {
  @override
