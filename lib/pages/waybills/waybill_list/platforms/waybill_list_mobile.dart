...
class WaybillListMobile extends StatefulWidget {
  final String? id;
  final String? customerId;
  const WaybillListMobile({
    super.key,
    this.id,
    this.customerId,
  });
  ...
  @override
  State<WaybillListMobile> createState() =>
      _WaybillListMobileState();
}

class _WaybillListMobileState
    extends State<WaybillListMobile> {
                  ...
                  builder: (context) {
                    if (widget.id != null
                      ...
                      return EmptyWidgetDisplayOnly(
                        title: 'Empty List',
                        subText:
                            'You don\'t have any Waybills under this category',
                        icon: Icons.clear,
                        theme: theme,
                        height: 35,
                        altAction: () {
