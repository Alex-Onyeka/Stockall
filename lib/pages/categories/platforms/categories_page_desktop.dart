...
class CreateCategoryWidget extends StatefulWidget {
  ...
  @override
  State<CreateCategoryWidget> createState() =>
      _CreateCategoryWidgetState();
}

class _CreateCategoryWidgetState
    extends State<CreateCategoryWidget> {
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(color: Colors.grey, size: 20, Icons.add),
            ],
          ),
        ),
      ),
