...
class CreatePurchaseMobile extends StatefulWidget {
  final TempPurchase? purchase;
  final TextEditingController searchController;
  final TextEditingController priceController;
  final TextEditingController quantityController;

  const CreatePurchaseMobile({
    super.key,
  ...
  @override
  State<CreatePurchaseMobile> createState() =>
      CreatePurchaseMobileState();
}

class CreatePurchaseMobileState
    extends State<CreatePurchaseMobile> {
