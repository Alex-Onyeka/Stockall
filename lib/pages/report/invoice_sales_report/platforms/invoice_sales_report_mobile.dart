...
class InvoiceSalesReportMobile extends StatefulWidget {
  const InvoiceSalesReportMobile({super.key});

  @override
  State<InvoiceSalesReportMobile> createState() =>
      _InvoiceSalesReportMobileState();
}

class _InvoiceSalesReportMobileState
    extends State<InvoiceSalesReportMobile> {
