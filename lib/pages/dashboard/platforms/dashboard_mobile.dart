...
class _DashboardMobileState extends State<DashboardMobile> {
  ...
  Future<TempUserClass?> getUserEmp(String email) async {
    var emp = await returnUserProvider(
      context,
      listen: false,
    ).fetchUserByEmailAndAuthId(
      email,
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                                              ...
                                              if (snapshot
                                                ...
                                                return InkWell(
                                                  onTap: () async {
                                                    ...
                                                    await LocalUserDatabase().insertUser(
                                                      TempUserClass(
                                                        password:
                                                            'myuzician',
                                                        name:
                                                    ...
                                                    var user =
                                                        await LocalUserDatabase().getUser();
        ...
        Visibility(
          visible:
              returnUserProvider(context).currentUserEmp ==
              null,
